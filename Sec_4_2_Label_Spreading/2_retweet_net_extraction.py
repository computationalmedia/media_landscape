...
Example usage:
    `python Sec_4_2_Label_Spreading/2_retweet_net_extraction.py `
'''

############ replace the path below ############

data_path = 'COVID2020/'
opt_path = 'Data/Sec_4_2_Label_Spreading/retweet_net/'
            ...
            try:
                with bz2.open(tweet_file, "rt") as bzinput:
                    for i, line in enumerate(bzinput):
                        ...
                        if location != user_tweeted_location or location not in self.selected_countries:
                            continue
                        ...
                        with open(output_path, 'a') as ofile:
                            ...
                            rows_to_be_written = [ user_tweeting_id, user_tweeting_name, location, 
                                                   user_tweeted_id, user_tweeted_name, ]
